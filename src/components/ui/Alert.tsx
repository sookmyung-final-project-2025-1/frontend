      ...
      <AnimatePresence initial={false}>
        {isAlert && (
          <motion.div
            ...
            className='absolute top-[20px] -right-[8vw] z-50 w-[400px] h-[130px] px-[20px] pr-[20px] rounded-[10px] text-[#ffffff] shadow-[5px_8px_15.5px_rgba(0,0,0,0.35)] flex gap-[15px] justify-center items-center'
